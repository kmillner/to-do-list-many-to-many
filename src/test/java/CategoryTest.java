...
public class CategoryTest {
  ...
  public void equals_returnsTrueIfDescriptionsAreTheSame() {
    Category firstCategory = new Category("Buy Foods");
    Category secondCategory = new Category("Buy Foods");

    assertTrue(firstCategory.equals(secondCategory));
  }
  @Test
  public void save_returnsTrueIfDescriptionsAreTheSame()  {
    Category myCategory = new Category("go to the gym");
     myCategory.save();
     assertTrue(Category.all().get(0).equals(myCategory));
  }
  @Test
  public void save_AssignsIdToObject() {
    Category myCategory = new Category ("deposit check");
    myCategory.save();
  ...
  public void find_findsCategoryInDatabase_true() {
    Category myCategory= new Category("buy vitamins");
    myCategory.save();
  ...
  public void getTasks_returnsAllTasks_ArrayList() {
    Category myCategory = new Category("grocery list");
    myCategory.save();

    Task myTask = new Task("watch Netflix all weekend");
    myTask.save();
  ...
  @Test
  public void delete_deletesAllTasksAndListsAssoications() {
    Category myCategory = new Category("Household chores");
    myCategory.save();
